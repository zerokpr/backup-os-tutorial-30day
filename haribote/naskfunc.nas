...
[FILE "naskfunc.nas"]
	...
	GLOBAL _asm_inthandler0c, _asm_inthandler0d	; 例外割り込み用
	GLOBAL _asm_hrb_api
	GLOBAL _start_app
	GLOBAL _asm_end_app
	GLOBAL __alloca
...
_io_out16:	; void io_out16(int port, int data);
	MOV EDX,[ESP+4]	; port
	MOV	EAX,[ESP+8]	; data	(ここはEAXじゃなくAXでもよいのでは？)
	OUT DX,AX
	RET
...
_io_store_eflags:	; int io_load_eflags(int eflags);
	MOV EAX,[ESP+4]
	PUSH EAX
